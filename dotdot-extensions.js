...
(function () {
  ...
  var shortcutQuery='';
  var shortcuts=[['Ctrl/⌘','A','현재 목록 전체 선택'],['Ctrl/⌘','C / X / V','복사·잘라내기·붙여넣기'],['Ctrl/⌘','Alt','C / V','연결 인스턴스 복사·붙여넣기'],['Ctrl/⌘','Alt','U','연결 해제'],['Ctrl/⌘','[ / ]','그룹 생성·해제'],['Ctrl/⌘','Z','실행 취소'],['Ctrl/⌘','Shift','Z','다시 실행'],['Ctrl/⌘','Y','다시 실행'],['Shift','클릭','범위 선택'],['Ctrl/⌘','클릭','비연속 선택'],['Delete','','휴지통 이동'],['Escape','','현재 조작 취소']];
